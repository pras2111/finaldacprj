...
public class HomeController {
	...
	@RequestMapping("/home")
	public String paymentPaytm(Model model) {
		model.addAttribute("paytmPage", true);
		return "home";
	}
	...
	public String newAccountPost(Locale locale, HttpServletRequest request, @ModelAttribute("email") String userEmail,
		...
		//String createdSuccesfully ="Your Account Created Succesfully, Please Login..";
		
		//model.addAttribute("createdSuccesfully",createdSuccesfully);
